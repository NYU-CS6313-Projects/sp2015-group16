...
var color = d3.scale.ordinal().range(["#E05A6D","#48A36D",  "#80A8CE","#E37756", "#E3CF6D","#E39158"]);


var drawline = function(file) {
...
//end slider part----------------------------------------------------------------------------------- 
  ...
  d3.csv(file, function(error, data) { 
   ...
   var brush = d3.svg.brush()//for slider bar at the bottom
    ...
    // draw line graph
    svg.append("g")
        .attr("class", "xx lineaxis")
        .attr("transform", "translate(0," + height + ")")
        .call(xAxis);

    svg.append("g")
        .attr("class", "yy lineaxis")
        .call(yAxis)
      .append("text")
    ...
    function brushed() {
      ...
      svg.select(".xx.lineaxis") // replot xAxis with transition when brush used
            .transition()
            .call(xAxis);
      ...
      svg.select(".yy.lineaxis") // Redraw yAxis
        .transition()
        .call(yAxis);   
